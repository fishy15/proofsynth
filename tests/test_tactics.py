...
@pytest.mark.parametrize(
    ...
    [
        ...
        (TDeMorganAndNot(THypothesis.new("!P && !Q")), "!(P || Q)"),
        (TDeMorganOrNot(THypothesis.new("!P || !Q")), "!(P && Q)"),
        (TDeMorganNotAnd(THypothesis.new("!(P && Q)")), "!P || !Q"),
        (TDeMorganNotOr(THypothesis.new("!(P || Q)")), "!P && !Q"),
